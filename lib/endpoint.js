...
class Endpoint extends EventEmitter {
  ...
  forkAudioStart() {
    return Promise.reject(new Error('mediajam: forkAudioStart pending Phase 2 (fork.*)'));
  }
  forkAudioStop() {
    return Promise.reject(new Error('mediajam: forkAudioStop pending Phase 2 (fork.*)'));
  }
  forkAudioPause() {
    return Promise.reject(new Error('mediajam: forkAudioPause pending Phase 2 (fork.*)'));
  }
  forkAudioResume() {
    return Promise.reject(new Error('mediajam: forkAudioResume pending Phase 2 (fork.*)'));
  }
  forkAudioSendText() {
    return Promise.reject(new Error('mediajam: forkAudioSendText pending Phase 2 (fork.*)'));
  }
  startVadDetection() {
